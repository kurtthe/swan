          ...
          <Block flex middle style={{ backgroundColor: '#fff' }}>
            ...
            <Block flex space='evenly'>
              <Block flex middle style={styles.socialConnect}>
                ...
                <Block flex={3} top middle
                       style={{ top: (Platform.OS === 'ios') ? ((Dimensions.get('window').height < 670) ? 15 : 10) : (Dimensions.get('window').height < 870) ? 15 : 15 }}>
                  <Text
                    style={{
                ...
                <Block middle top flex={3}
                       style={{ top: (Platform.OS === 'ios') ? ((Dimensions.get('window').height < 670) ? 10 : -20) : (Dimensions.get('window').height < 870) ? 10 : -20 }}
                       width={width * 0.9}>
                  <Text
                ...
                <Block center flex={0.9}>
                  <Block flex space='between' middle>
                    ...
                    <Block>
                      ...
                      <Block
                        flex={(Platform.OS === 'ios') ? ((Dimensions.get('window').height < 670) ? 0.3 : 0.15) : (Dimensions.get('window').height < 870) ? 0.255 : 0.15}
                        style={{
                          marginTop:
                    ...
                    <Block
                      flex={(Platform.OS === 'ios') ? ((Dimensions.get('window').height < 670) ? 0.8 : 0.45) : (Dimensions.get('window').height < 870) ? 1 : 0.4}
                      ...
                      <SimpleButton onPress={() => navigation.navigate('Help')}> <Text
                        style={{ textDecorationLine: 'underline' }}>Need Help?</Text></SimpleButton>
